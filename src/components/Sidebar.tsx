...
const Sidebar: React.FC<SidebarProps> = ({ activeSection, setActiveSection, isOpen, onClose }) => {
  ...
  const allMenuItems = [
    ...
    { id: 'urenregistratie', label: 'Urenregistratie (oud)', icon: Clock, permission: 'register_hours', module: 'time_registration' },
    { id: 'urenregistratie-v2', label: 'Urenregistratie', icon: Clock, permission: 'register_hours', module: 'time_registration_v2' },
